...
depends_on = [
    ...
    key_name  ="chinmay_prince"                //enter key_pair name you created at aws console
...
connection {
    type     = "ssh"
    user     = "ec2-user"
    private_key = file("C:/Users/OM/Downloads/chinmay_prince.pem")  
...
provisioner "remote-exec"{
    inline = [
      ...
      "sudo git clone https://github.com/Chirag321ratvekar/Hybrid-Multicloud-Task-2.git /var/www/html/"  //edit the path of source code enter your site path  	
    ]
  }
